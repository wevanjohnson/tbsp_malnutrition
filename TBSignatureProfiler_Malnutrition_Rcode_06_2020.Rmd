...
saveRDS(indata, file = "~/projects/malnutrition/manuscript_BMC_ID/indata_SCE_batchcorrect.rds")
```
...
singleCellTK::plotPCA(indataSCE, useAssay = "log_cpm", runPCA = TRUE, colorBy = "batch",shape = "status")
  ...
  png(filename = "~/projects/malnutrition/manuscript_BMC_ID/figures/PCA_raw.png", width = 4, height = 3, units = "in",
      res = 150)
singleCellTK::plotPCA(indataSCE, useAssay = "log_cpm", runPCA = TRUE, colorBy = "batch",shape = "status")
  dev.off()
...
singleCellTK::plotPCA(indataSCE, useAssay = "log_cpm", runPCA = TRUE, colorBy = "batch",shape = "status")
 ...
 png(filename = "~/projects/malnutrition/manuscript_BMC_ID/figures/PCA_adj_colbatch.png", width = 4, height = 3, units = "in",
      res = 150)
singleCellTK::plotPCA(indataSCE, useAssay = "log_cpm", runPCA = TRUE, colorBy = "batch",shape = "status")
  dev.off()
...
singleCellTK::plotPCA(indataSCE, useAssay = "log_cpm", runPCA = TRUE, shape = "batch",colorBy = "status")
 ...
 png(filename = "~/projects/malnutrition/manuscript_BMC_ID/figures/PCA_adj_colstatus.png", width = 4, height = 3, units = "in",
      res = 150)
singleCellTK::plotPCA(indataSCE, useAssay = "log_cpm", runPCA = TRUE, shape = "batch", colorBy = "status")
  dev.off()
...
png(filename = "~/projects/malnutrition/manuscript_BMC_ID/figures/genes_in_5plus.png", width = 8, height = 7, 
      units = "in", res = 150)
...
## Methods Table XX: Signature Overlap
```{r}  
...
## Figure 1. Heatmap of all signatures (ssGSEA)
...
## Supplementary Figure 1. Heatmap of all signatures  (GSVA)
...
## Figure 2b. Boxplot of the scores (LTBI v TB) by signature
...
## Supplementary Figure 2a. GSVA results
  
```{r}
  png(filename = "~/projects/malnutrition/manuscript_BMC_ID/figures/AUC_boxplot_GSVA.png", width = 10, height = 10, units = "in",
      res = 150)
...
## Supplementary Figure 2b. GSVA results
...
## Figure 3. Heatmap of genes for selected signatures {.tabset}
```{r}
  # Sambarey_HIV_10
...
### Lee_4
```{r}
  png(filename = "~/projects/malnutrition/manuscript_BMC_ID/figures/Lee_4.png", width = 6, height = 4, units = "in",
      res = 150)
  signatureGeneHeatmap(ssgsea_res, useAssay = "log_cpm", 
                       TBsignatures[["Lee_4"]],
...
### Maertzdorf_4
```{r}
  png(filename = "~/projects/malnutrition/manuscript_BMC_ID/figures/Maertzdorf_4.png", width = 6, height = 4, units = "in",
      res = 150)
  signatureGeneHeatmap(ssgsea_res, useAssay = "log_cpm", 
...
## Supplementary figure XX: ROC curves for all sigs
```{r}

  # ssGSEA
  png(filename = "~/projects/malnutrition/manuscript_BMC_ID/figures/ssgsea_ROC.png", width = 11, height = 9, units = "in",
      res = 150)
...
## GSVA
```{r}
  png(filename = "~/projects/malnutrition/manuscript_BMC_ID/figures/gsva_ROC.png", width = 11, height = 9, units = "in",
      res = 150)
...
```{r}
  ...
  write.csv(out.ssgsea, file = "~/projects/malnutrition/manuscript_BMC_ID/figures/ssGSEA_TableAUC.csv")
```
...
## Supplementary figure XX: TableAUC for PLAGE 
```{r}
...
## Supplementary figure 6a: PLAGE results 

```{r}
  png(filename = "~/projects/malnutrition/manuscript_BMC_ID/figures/AUC_boxplot_.png", width = 10, height = 10, units = "in",
      res = 150)
...
```{r}
  ...
  png(filename = "~/projects/malnutrition/manuscript_BMC_ID/figures/score_boxplot_PLAGE.png", width = 7, height = 5, 
      units = "in", res = 150)
  par(mar = c(7,2,2,1))
...
## Supplementary Figure 4. Heatmap of all signatures (PLAGE)
```{r}
  
  png(filename = "~/projects/malnutrition/manuscript_BMC_ID/figures/Heatmap_PLAGE.png", width = 12, height = 10, units = "in",
      res = 150)
